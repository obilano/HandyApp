  ...
  Widget build(BuildContext context) {
    return pageInfo(
      ...
      location: "Sweetwater Depot "
          "\n502 S Royal Ave Florence, AL 35630",
      date: "July 18",
      time: "10:00 AM",
      sponsor: "Northwest Alabama RC&D * Music Preservation Society, Inc.",
      cost: "",
      feat: "Locally raised lamb and chicken prepared by Chef Alan Phillips",
      description:
...
class FondaSkipworth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return pageInfo(
      ...
      feat: "",
      description: "",
      youtubeUrl: "https://www.youtube.com/watch?v=i3g0ETRu_9U",
      mapUrl:
  ...
  Widget build(BuildContext context) {
    return pageInfo(
        ...
        location: "Sheffield Library"
            "\n316 North Montgomery Avenue, Sheffield, AL 35660",
        date: "Friday July 19",
        time: "10:00 AM",
        ...
        description: "IN HARMONY WITH NATURE LITTER-FREE EVENT",
        youtubeUrl:
  ...
  Widget build(BuildContext context) {
    return pageInfo(
      ...
      location: "Keestone of Florence "
          "\n201 North Cedar St. Florence, AL 35630",
      date: "July 19",
...
class WCHandyMovie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return pageInfo(
      ...
      genre: "Other",
      location: "Alabama Music Hall of Fame Lobby 617 "
          "\nUS Hwy 72 West Tuscumbia, AL 35674",
      date: "July 23",
      time: "10:00 PM",
      sponsor: "Friends of the Florence-Lauderdale Public Library",
      cost: "",
      feat: "St. Louis Blues, movie starring Nat “King” Cole as W.C. Handy",
      description: "",
      youtubeUrl: "",
      mapUrl: "",
    );
